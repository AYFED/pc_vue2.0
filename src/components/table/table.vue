<template>
    <div :class="wrapClasses" :style="styles">
        ...
        <Spinner v-if="loadingSpinner"></Spinner>
    </div>
</template>
<script>
  ...
  export default {
    name: 'Table',
    mixins: [Locale],
    components: {tableHead, tableBody, Spin, Spinner},
    props: {
      data: {
        type: Array,
        default () {
...
//                    const width = this.bodyHeight === 0 ? this.tableWidth : this.tableWidth - this.scrollBarWidth;
    ...
    methods: {
      ...
      handleResize () {
        ...
        let usableWidth = tableWidth - unUsableWidth - sumMinWidth -
          (this.showVerticalScrollBar ? this.scrollBarWidth : 0) - 1
      ...
      fixedBody () {
        ...
        if (!this.$refs.tbody || !this.data || this.data.length === 0) {
          ...
          this.showVerticalScrollBar = this.bodyHeight ? bodyHeight -
            (this.showHorizontalScrollBar ? this.scrollBarWidth : 0) < bodyContentHeight : false
